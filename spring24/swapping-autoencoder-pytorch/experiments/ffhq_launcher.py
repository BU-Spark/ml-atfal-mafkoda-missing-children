...
class Launcher(TmuxLauncher):
    def options(self):
        ...
        opt.set(
            ...
            checkpoints_dir="/projectnb/sparkgrp/ml-atfal-mafkoda-grp/swapping-autoencoder-pytorch/checkpoints/",
    ...
    def test_options(self):
        opts = self.options()
        print("Checking path:", os.path.abspath("../testphotos/ffhq512/fig9/"))
        return [
            # Fig 9 of Appendix
